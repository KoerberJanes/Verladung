		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Verladung",
									"targetURL": "#suptpverladung20-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"suptpverladung20-display": {
								"semanticObject": "suptpverladung20",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=suptpverladung2.0",
									"url": sap.ui.require.toUrl("suptpverladung2/0")
								}
							}
						}
					}
